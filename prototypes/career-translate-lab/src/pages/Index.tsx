    ...
    <>
      ...
      <section className="relative overflow-hidden">
        <div className="container-prose pt-20 md:pt-32 pb-24 md:pb-40">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <CTAButton to="/diagnosis" variant="primary">브랜딩 준비도 진단하기</CTAButton>
        ...
        <div className="container-prose">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            {Object.values(PACKAGES).map((p) => (
              ...
              >
                {p.highlighted && (
                  <span className="absolute -top-3 left-8 bg-accent text-primary text-xs px-3 py-1 rounded-full tracking-widest">
                    RECOMMENDED
                  </span>
                )}
      ...
      <section className="bg-secondary/70">
        <div className="container-prose py-24 md:py-32 text-center">
          ...
          <h2 className="font-serif mt-6 text-3xl md:text-5xl text-primary leading-[1.25] max-w-3xl mx-auto">
            오래 쌓아온 경력은 사라지는 것이 아니라,
            <br />다시 번역되어야 합니다.
          </h2>
