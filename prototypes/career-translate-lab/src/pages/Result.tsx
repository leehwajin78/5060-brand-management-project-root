  ...
  if (!result) {
    return (
      <div className="container-prose py-32 text-center">
        ...
        <p className="mt-4 text-muted-foreground">먼저 16문항 브랜딩 준비도 진단을 진행해주세요.</p>
        <div className="mt-10">
          <CTAButton to="/diagnosis">진단 시작하기</CTAButton>
        </div>
      </div>
    );
  }
          ...
          <div className="container-prose py-24 text-center">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 bg-accent text-primary px-7 py-3.5 rounded-full text-sm"
              >
                진단 결과 기반 1:1 상담 신청 →
              </button>
              <Link to="/" className="inline-flex items-center gap-2 border border-primary-foreground/30 px-7 py-3.5 rounded-full text-sm">
                홈으로
              </Link>
            </div>
          </div>
